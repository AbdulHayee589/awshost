          ...
          <div
            ...
            style={{
              backgroundImage: selectedFile
                ? `url(${`http://localhost:5000${selectedFile}`})`
                : "none",
              ...
              <div className={`${isNonMobile ? "m-5" : ""} row`}>
                ...
                >
                  <div className="roundedpreviewicons  ">
                    <img
                      src={JSON.parse(company).country[0].icon}
                ...
                <div className="mt-5">
                  <button
                    ...
                    onClick={() => navigate("/challenge/attempt")}
                  >
                    Start Challenge
                    <svg
        ...
        >
          <div className="m-5">
            <p className="Welcomemsg">
              Welcome to the {JSON.parse(company).title} {type} challenge.
            </p>
                ...
                <div>
                  ...
                  <div className="video-container">
                    {selectedVideo && (
                      <>
                        <ReactPlayer
                          url={`${`http://localhost:5000${selectedVideo}`}`}
                          controls
                          width="100%"
                          height="100%"
            ...
            <div className="m-3 mt-0 mb-0">
              <p className="maybeLater">
                ...
                <button
                  ...
                  onClick={() => navigate("/student/dashboard/challenge")}
                >
                  {" "}
                  Back to Search.
                </button>
